...
import { 
  ...
  BookOpen, Globe, Hash, Calendar, User
} from 'lucide-react'

const PaperSubmissionSystem = () => {
  ...
  const paperTypes = [
    ...
    { value: 'industry', label: 'Industry Paper (4-8 pages)', icon: Building },
...
export default PaperSubmissionSystem